...
public class PieController implements BaseStatusBar.NavigationBarCallback, PieView.OnExitListener,
    ...
    public PieController(Context context, BaseStatusBar statusBar, EdgeGestureManager pieManager) {
        mContext = context;
        ...
        mActionTarget = new ActionTarget(mContext);
    }
    ...
    private void setupContainer() {
        if (mPieContainer == null) {
            mPieContainer = new PieView(mContext, mStatusBar);
    ...
    public void onLongClick(PieItem item) {
        ...
        if (!mActionTarget.isActionKeyEvent(type)) {
        ...
        mActionTarget.launchAction(type);
    }
